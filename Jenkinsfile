pipeline {
    ...
    stages {
        ...
        stage("Jenkins Post data"){
            steps{
                sh 'curl --user admin:1162207dd2a10fee2befea169bc3c7febf -H "Accept: application/json+v3" http://Jenkins-Fourkeys-910524825.us-east-2.elb.amazonaws.com/job/issue_pipeline/lastBuild/api/json -o myresponse.json'
